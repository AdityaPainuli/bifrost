...
| `stream_replay_duration_ms` | No | Maximum time to replay an allowed stream buffered by block-capable output guardrails. Smaller streams may finish sooner. Defaults to `200`; `0` sends all buffered events immediately. |
